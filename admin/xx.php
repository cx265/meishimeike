...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="#">管理分类<!--[if IE 7]><!--></a><!--<![endif]-->
                    ...
                    <li><a href="#">用户管理<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                    ...
                    <li><a href="./MicorClass.php">微课管理<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="./MicorClass.php" title="审阅微课">审阅微课</a></li>
                        <li><a href="./MicorClass.php" title="发布微课">发布微课</a></li>
                        <li><a href="./MicorClass.php" title="微课评价">微课评价</a></li>
                        <li><a class="sub1" href="#nogo">微课分类<!--[if IE 7]><!--></a><!--<![endif]-->
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                            <ul>
                    ...
                    <li><a href="#">消息发布<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
